...
public class TargetIndicator : MonoBehaviour
{
    ...
    protected void SetIndicatorPosition()
    {
        ...
        else
        {
            ...
            rectTransform.position = isCentralBlackHole ? Vector3.Lerp(rectTransform.position, new Vector3(hitPoint.x, hitPoint.y, indicatorPos.z), 0.1f) : new Vector3(hitPoint.x, hitPoint.y, indicatorPos.z);
        }
    }
